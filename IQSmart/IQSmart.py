...
class IQSmart():
    ...
    def __init__(self):
        '''
        Theia IQ Smart lens calculations and motor control functions (c)2023 Theia Technologies. 
        Contact Theia at mpeterson@theiatech.com for more information about this module. 
